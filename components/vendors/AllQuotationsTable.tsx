            ...
            <div className="flex flex-col sm:flex-row gap-3 flex-shrink-0">
                <div className="flex-grow relative">
                    <Input 
                        ...
                        placeholder="Search quotations by vendor, name, date, or category..." 
                        value={search} 
                ...
                <table className="min-w-full divide-y divide-slate-200 text-sm relative">
                    <thead className="bg-slate-50 sticky top-0 z-10 shadow-sm">
                        <tr>
                            ...
                            <th onClick={() => handleSort('name')} className="px-4 py-3 text-left font-semibold text-slate-600 cursor-pointer hover:bg-slate-100 select-none whitespace-nowrap">Quotation Name <SortIcon column="name"/></th>
                        ...
                        {filteredQuotations.length > 0 ? filteredQuotations.map(quotation => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <td className="px-4 py-3 font-medium text-slate-800 group-hover:text-accent">{vendor?.name || 'Unknown'}</td>
