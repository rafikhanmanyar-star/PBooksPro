...
export const reportDefinitions: ReportDefinition[] = [
    ...
    { id: 'project-client-ledger', title: 'Owner Ledger (Project)', group: 'Project', path: 'projectSelling', subPath: 'Reports:Owner Ledger' },
    ...
    { id: 'project-financial-position', title: 'Project Financial Position', group: 'Project', path: 'projectManagement', subPath: 'Reports:Project Financial Position' },
    { id: 'project-profitability', title: 'Project Profitability', group: 'Project', path: 'projectManagement', subPath: 'Reports:Project Profitability' },
    { id: 'project-cash-flow', title: 'Project Cash Flow', group: 'Project', path: 'projectManagement', subPath: 'Reports:Project Cash Flow' },
    ...
    { id: 'accounting-balance-sheet', title: 'Balance Sheet', group: 'Accounting', path: 'accounting', subPath: 'Reports:Balance Sheet' },
