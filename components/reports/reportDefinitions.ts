...
export const reportDefinitions: ReportDefinition[] = [
    ...
    { id: 'project-pev-register', title: 'Project Expense Register', group: 'Project', path: 'projectManagement', subPath: 'Reports:Project Expense Reports' },
    { id: 'project-pev-by-category', title: 'Project Expenses by Category', group: 'Project', path: 'projectManagement', subPath: 'Reports:Project Expense Reports' },
