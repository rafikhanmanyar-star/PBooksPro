        ...
        <div className="w-full px-4 sm:px-6 h-16 flex items-center justify-between gap-4">
          ...
          <div className="hidden md:flex flex-1 max-w-xl justify-center">
            <button
              ...
              className="w-full max-w-md flex items-center gap-3 px-4 py-2.5 bg-slate-50 border border-slate-200 text-slate-400 rounded-xl hover:bg-white hover:border-slate-300 hover:shadow-sm transition-all group"
            >
          ...
          <div className="flex items-center gap-2 sm:gap-4 justify-end flex-1">
            ...
            <button
              className="p-2 rounded-full text-slate-500 hover:bg-slate-100 hover:text-indigo-600 transition-colors relative group hidden sm:block"
              title="Notifications"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"></path><path d="M13.73 21a2 0 0 1-3.46 0"></path></svg>
              <span className="absolute top-2 right-2 w-2 h-2 bg-rose-500 rounded-full border-2 border-white"></span>
            </button>

            <button
              onClick={() => setIsHelpModalOpen(true)}
              className="p-2 rounded-full text-slate-500 hover:bg-slate-100 hover:text-indigo-600 transition-colors hidden sm:block"
              title="Help & Support"
            >
