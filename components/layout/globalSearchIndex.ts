...
export const SETTINGS_SECTIONS: SettingsSearchItem[] = [
  ...
  { id: 'settings-permissions', categoryId: 'permissions', label: 'Permission Matrix', subtitle: 'Settings · Access control', keywords: ['role', 'rbac', 'access', 'matrix'] },
  { id: 'settings-role-management', categoryId: 'role-management', label: 'Role Management', subtitle: 'Settings · Administration', keywords: ['role', 'rbac', 'security administrator'] },
  { id: 'settings-permission-catalog', categoryId: 'permission-catalog', label: 'Permission Catalog', subtitle: 'Settings · Administration', keywords: ['permission', 'rbac', 'catalog'] },
