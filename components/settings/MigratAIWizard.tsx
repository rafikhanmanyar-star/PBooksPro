...
type WizardStep = 'upload' | 'map' | 'process';
...
const MigratAIWizard: React.FC<MigratAIWizardProps> = ({ onClose }) => {
    ...
    const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>, type: 'source' | 'template') => {
        ...
        try {
            ...
            console.error(error);
            showAlert("Failed to read Excel file. Please ensure it is a valid .xlsx or .xls file.");
        }
    };
    ...
    const renderUploadStep = () => (
        <div className="space-y-8 py-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                >
                    <input type="file" accept=".xlsx, .xls" ref={sourceInputRef} className="hidden" onChange={(e) => handleFileUpload(e, 'source')} />
