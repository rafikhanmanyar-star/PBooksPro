...
10. [Global Payroll](#global-payroll)
11. [Loan Manager](#loan-manager)
...
### Test Case 9.1: View Global Payroll
**Steps:**
...
**Expected Result:**
- [ ] Payroll page loads
- [ ] All payroll sections are accessible:
   - Employees
   - Payroll Cycles
   - Payslips
   - Reports
...
- [ ] Employee can be used in payroll
...
### Test Case 9.3: Manage Salary Components
**Steps:**
1. Navigate to Payroll > Salary Structure
2. Create salary component
3. Set type (Earning/Deduction/Allowance/etc.)
4. Set calculation type
5. Save

**Expected Result:**
- [ ] Salary component is created
- [ ] Component can be assigned to employees
...
### Test Case 9.4: Create Payroll Cycle
**Steps:**
1. Navigate to Payroll > Payroll Cycles
2. Click "New Cycle" or "Run Payroll"
3. Fill in:
   - Month
   - Frequency
   - Pay period dates
...
**Expected Result:**
- [ ] Payroll cycle is created
- [ ] Payslips are generated for all active employees
- [ ] Calculations are correct
- [ ] Cycle status is "Draft" or "Processing"
...
### Test Case 9.5: Review and Approve Payslips
**Steps:**
1. Navigate to Payroll > Payslips
2. Review generated payslips
3. Approve payslips (individual or bulk)
4. Check payslip details

**Expected Result:**
- [ ] Payslips are displayed correctly
- [ ] Payslip details are accurate
- [ ] Approval works
...
### Test Case 9.6: Pay Payslips
**Steps:**
1. Navigate to Payroll > Payslips
2. Select approved payslips
3. Click "Pay" or "Bulk Pay"
4. Enter payment account and date
5. Process payment

**Expected Result:**
- [ ] Payment is recorded
- [ ] Payslip status changes to "Paid"
- [ ] Transaction is created
- [ ] Account balance updates
...
### Test Case 9.7: Add Bonus
**Steps:**
1. Navigate to Payroll > Employees
2. Select an employee
3. Add bonus record
4. Fill in bonus details
5. Save

**Expected Result:**
- [ ] Bonus is added
- [ ] Bonus appears in employee record
- [ ] Bonus is included in next payroll
...
### Test Case 9.8: Add Loan/Advance
**Steps:**
1. Navigate to Payroll > Employees
2. Select an employee
3. Add loan or advance
4. Set repayment terms
5. Save

**Expected Result:**
- [ ] Loan/advance is recorded
- [ ] Repayment schedule is created
- [ ] Deductions are applied in payroll
...
### Test Case 9.9: Employee Lifecycle Events
**Steps:**
1. Navigate to Payroll > Employees
2. Select an employee
3. Perform lifecycle event:
   - Promotion
   - Transfer
   - Increment
   - Termination
...
### Test Case 9.10: Payroll Reports
**Steps:**
