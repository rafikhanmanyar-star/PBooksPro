...
app.use('/api', authMiddleware, rentalReceivableRouter);
app.use('/api', authMiddleware, ownerIncomeSummaryRouter);
app.use('/api', authMiddleware, ownerSecurityDepositRouter);
