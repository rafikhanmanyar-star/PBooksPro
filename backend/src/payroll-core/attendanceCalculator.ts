/**
 * AUTO-GENERATED — do not edit. Source: shared/payroll-core/attendanceCalculator.ts
 * Regenerate: node scripts/ensure-shared-financial-cores.mjs
 */

import type { AttendanceStatusCounts, ComputedAttendanceSummary, WorkWeekConfig } from './payrollTypes.js';
import { DEFAULT_WORK_WEEK } from './payrollTypes.js';
