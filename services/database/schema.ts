...
CREATE TABLE IF NOT EXISTS contracts (
    ...
    document_path TEXT,
    document_id TEXT,
    retention_type TEXT NOT NULL DEFAULT 'NONE',
    retention_percentage REAL,
    retention_amount REAL,
    retention_release_method TEXT,
    retention_release_date TEXT,
    retention_notes TEXT,
    retention_balance REAL NOT NULL DEFAULT 0,
    retention_released REAL NOT NULL DEFAULT 0,
    retention_release_by TEXT,
    user_id TEXT,
    created_at TEXT NOT NULL DEFAULT (datetime('now')),
    updated_at TEXT NOT NULL DEFAULT (datetime('now')),
    version INTEGER NOT NULL DEFAULT 1,
