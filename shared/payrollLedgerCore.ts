/**
 * Canonical payroll ledger row builder (shared client + server semantics).
 * Synced to backend via scripts/ensure-payroll-ledger-core.mjs on build.
 *
 * PAYSLIP transaction_date: payslip created_at calendar day first, then period fallbacks.
 */
