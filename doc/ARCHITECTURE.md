...
|--------|------|--------------|
| accounting | `modules/accounting/` | `JournalRepository`, `FinancialPostingService` |
...
| vendors | `modules/vendors/` | `BillRepository` |
| customers | `modules/customers/` | `InvoiceRepository` |
| project-selling | `modules/project-selling/` | `ProjectAgreementRepository` |
